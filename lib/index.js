...
const { NotesDB, getNotes, saveNote, deleteNoteById, deleteAllNotes } = require("./database/notes")
const {
...
module.exports = {
  ...
  IGDL: async function igdl(igurl) {
  ...
  styletext: async function styletext(text) {
    try {
        ...
        return {
            status: false,
            error: 'Error fetching or processing data: ' + error.message
        };
    }
},
twitter: async function twitter(url) {
  try {
    let datad = {
    'URL': url
    };
    const response = await axios.post("https://twdown.net/download.php", qs.stringify(datad), {
    'headers': {
